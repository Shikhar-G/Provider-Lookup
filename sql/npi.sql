...
CREATE INDEX IF NOT EXISTS npi_main ON npi(npi);
CREATE INDEX IF NOT EXISTS lname ON npi(last_name);
CREATE INDEX IF NOT EXISTS citystate ON npi(addr_practice_city,addr_practice_state);
CREATE INDEX IF NOT EXISTS fullname on npi(last_name, first_name);

---- Index on taxonomy
CREATE INDEX IF NOT EXISTS npi_tax ON npi_taxonomy(npi);
